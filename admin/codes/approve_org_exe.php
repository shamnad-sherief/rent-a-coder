...
if($page_action=='update')
    {
        if($exe=='inactive')
        {
            ...
            if($exe2['Status']=='true')
            {
                echo $obj->alert("Approved","../org_requests.php?sts=inactive");
            }
            else
            {
        ...
        elseif($exe=='rejected')
        {
            ...
            if($exe2['Status']=='true')
            {
                echo $obj->alert("Approved","../org_requests.php?sts=rejected");
            }
            else
            {
                echo $obj->alert("Something Went Wrong","../org_requests.php?sts=rejected");
            }
